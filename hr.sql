...
SELECT
	...
	e.SALARY
FROM EMPLOYEES e
WHERE e.DEPARTMENT_ID IN (SELECT DISTINCT e.DEPARTMENT_ID FROM EMPLOYEES e 
WHERE e.SALARY > (SELECT round(AVG(e.SALARY)) FROM EMPLOYEES e) AND e.LAST_NAME LIKE '%u%');
